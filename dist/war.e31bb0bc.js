...
var checkResponse = function checkResponse(response) {
  if (response.status !== 200) {
    return console.log("Error with request ".concat(response.status));
  }
...
var getDeckId = function getDeckId() {
  return getData('https://deckofcardsapi.com/api/deck/new/shuffle/?deck_count=1').then(function (data) {
    return data.deck_id;
  });
};

var getCards = function getCards(id) {
  return getData("https://deckofcardsapi.com/api/deck/".concat(id, "/draw/?count=52")).then(function (response) {
    return response.cards;
  });
};

var makeTwoPiles = function makeTwoPiles(cards) {
  return {
...
var createDeck = function createDeck() {
  return getDeckId().then(getCards).then(makeTwoPiles);
};
...
var Player = function Player(_ref) {
  var playerName = _ref.playerName,
      score = _ref.score,
      playedPile = _ref.playedPile;
  var card = playedPile.slice(-1)[0];
  return _react.default.createElement("div", null, _react.default.createElement("div", null, playerName, ": ", score), score ? _react.default.createElement("img", {
    src: _cardBack.default
  }) : _react.default.createElement("div", {
    className: "emptySpace"
  }), card ? _react.default.createElement("img", {
    src: card.image
  }) : _react.default.createElement("div", {
    className: "emptySpace"
  }));
...
var _board = _interopRequireDefault(require("./src/components/board"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var App = function App() {
  return _react.default.createElement(_board.default, null);
};

(0, _reactDom.render)(_react.default.createElement(App, null), document.getElementById('root'));
},{"react":"node_modules/react/index.js","react-dom":"node_modules/react-dom/index.js","./src/components/board":"src/components/board.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/war.e31bb0bc.map